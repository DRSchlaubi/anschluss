...
*/
export class ContractualKnowledge {
    /**
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        {
            ...
            "baseName": "destinationTime",
            "type": "Date",
            "format": "date-time"
        },
        {
            "name": "destinationTimeSchedule",
            "baseName": "destinationTimeSchedule",
            "type": "Date",
            "format": "date-time"
        },
        {
            "name": "destinationTimeType",
            "baseName": "destinationTimeType",
            "type": "TimeType",
            "format": ""
        },
        {
            "name": "originSchedule",
            "baseName": "originSchedule",
            "type": "StopPlaceEmbedded",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return ContractualKnowledge.attributeTypeMap;
    }
