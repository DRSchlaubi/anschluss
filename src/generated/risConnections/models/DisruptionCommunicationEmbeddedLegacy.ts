...
*/
export class DisruptionCommunicationEmbeddedLegacy {
    /**
    ...
    */
    ...
    static readonly attributeTypeMap: Array<{name: string, baseName: string, type: string, format: string}> = [
        ...
        {
            "name": "disruptionCommunicationID",
            "baseName": "disruptionCommunicationID",
            "type": "string",
            "format": ""
        },
        {
            "name": "disruptionID",
            "baseName": "disruptionID",
            "type": "string",
            "format": ""
        }    ];

    static getAttributeTypeMap() {
        return DisruptionCommunicationEmbeddedLegacy.attributeTypeMap;
    }
