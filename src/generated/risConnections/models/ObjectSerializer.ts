...
let typeMap: {[index: string]: any} = {
    ...
    "CodeShare": CodeShare,
    "ConnectionArrival": ConnectionArrival,
    "ConnectionEvaluationLegacy": ConnectionEvaluationLegacy,
    "ContractualKnowledge": ContractualKnowledge,
    "DirectionInfo": DirectionInfo,
    "DispositionStatus": DispositionStatus,
    "DisruptionCommunicationDescription": DisruptionCommunicationDescription,
    "DisruptionCommunicationEmbeddedLegacy": DisruptionCommunicationEmbeddedLegacy,
    "ErrorDetail": ErrorDetail,
    "ErrorResponse": ErrorResponse,
    "MessageAttributeLegacy": MessageAttributeLegacy,
    "MessageLegacy": MessageLegacy,
    "ReplacementTransport": ReplacementTransport,
    "StopAtStopPlace": StopAtStopPlace,
    "StopAtStopPlacePrio": StopAtStopPlacePrio,
    "StopDepartureConnect": StopDepartureConnect,
    "StopPlaceEmbedded": StopPlaceEmbedded,
    "TransportPublicDestination": TransportPublicDestination,
    "TransportPublicDestinationPortionWorking": TransportPublicDestinationPortionWorking,
    "TransportPublicDestinationVia": TransportPublicDestinationVia,
}
